...
/// Creates a new "aporte rápido" chip for a goal. Used from three call
/// sites: `CreateGoal` seeding the two default chips ($50.000/$100.000) right
/// after a goal is created, the "+ Nueva" sheet's own CTA, and the write
/// behind the "Deshacer" snackbar action after a chip's deletion (a simple
/// re-insertion, not a restore of the original row).
@injectable
