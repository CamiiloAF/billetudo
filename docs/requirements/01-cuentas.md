...
- Elijo una moneda ISO-4217 (ej. COP, USD, MXN) al crear la cuenta; no cambia después sin flujo explícito de conversión (ver `12-multi-moneda.md`).
...
- Se muestra un **saldo combinado** = suma de los saldos de las cuentas seleccionadas.
  - **Edge case multi-moneda:** si las cuentas seleccionadas tienen monedas distintas, no se suma un total único; se muestra un subtotal por moneda (la conversión se define en `12-multi-moneda.md`).
