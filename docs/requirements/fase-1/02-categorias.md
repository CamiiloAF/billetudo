...
**Criterios de aceptación:**
- **No hay paso de selección en el onboarding** (decisión cerrada, `13-onboarding.md` #1): el catálogo se siembra **completo y en silencio** en el primer arranque, desde `bootstrap.dart`. El usuario depura lo que no use desde esta pantalla (HU-03/HU-04), no antes de empezar. Las reglas de origen, idempotencia y fusión son las de esta HU — `13-onboarding.md` no las redefine.
