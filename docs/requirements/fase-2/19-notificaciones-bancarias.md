...
**Catálogo de emisores del lanzamiento (decisión 2026-08-27):** Bancolombia, Nu (Nubank), Nequi, Davivienda, Daviplata, BBVA Colombia — los de mayor penetración en el mercado objetivo es-CO — más **Google Wallet / Google Pay**, que usa el mismo mecanismo sin costo adicional de implementación y captura pagos NFC que la app del banco a veces no notifica por separado. Google Wallet es además el emisor de menor riesgo de política (es una app de Google, no un banco de terceros).
