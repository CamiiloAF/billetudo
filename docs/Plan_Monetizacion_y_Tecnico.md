...
| **Import/Export** impecable: importa desde **cualquier CSV** (Wallet, Mint, tu banco) con mapeo de columnas asistido, y respaldo completo restaurable | Feature de *confianza*: "nunca te sentirás atrapado". Gratis a propósito. Detalle en `docs/requirements/fase-1/11-import-export.md` |
