...
- **Rendimiento**: el saldo materializa las filas de movimiento en Dart. Suficiente para Fase 1 (SQLite local, un usuario); si el perfilado lo pide, agregar por buckets en SQL manteniendo los signos en el dominio.
