...
- Multi-moneda (HU-01/03, ver `docs/requirements/11-multi-moneda.md`) queda fuera de alcance: `currency` = moneda de la cuenta seleccionada, sin conversion.
