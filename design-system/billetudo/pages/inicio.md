...
- **Acceso rápido (item 7):** Metas entró como último chip (Pagos Programados dejó de necesitar chip si ya está en el Tab Bar — ver abajo). El código es la fuente de verdad del set exacto de chips.
