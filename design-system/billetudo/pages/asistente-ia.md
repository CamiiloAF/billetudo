...
- **`AI Assistant` (`cwxZI`, orbe+chips)** hoy vive en la hoja de "próximamente" (`ComingSoonSheet`). Si esta pantalla se implementa, decidir si ese bloque pasa a ser el estado vacío del chat (primera conversación, sin mensajes) en vez de quedar en una hoja aparte.
